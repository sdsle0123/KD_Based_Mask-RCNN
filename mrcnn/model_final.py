...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet18", "resnet34", "resnet50", "resnet101"]
    return np.array(
...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        # student_model = keras.models.load_model( r"D:\Coding\MRCNN_KD\student_model0420.h5",
        # custom_objects={'BatchNorm':KL.BatchNormalization})
        # # student_model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
        # student_model.trainable = True

        # input_image = student_model.inputs
        ...
        # C2,C3,C4,C5 = resnet_graph_student(input_image)
        ...
        # P2 = BatchNormalization(name="fpn_p2_Depthwise_BN")(P2)
        P2 = KL.Conv2D(256, (1,1), padding='valid', name="fpn_p2_Pointwise")(P2)
        # P2 = BatchNorm(name="fpn_p2_bn")(P2, training=True)
        P2 = BatchNormalization(name="fpn_p2")(P2)
        P3 = KL.DepthwiseConv2D((3,3), strides=1, padding="SAME", depth_multiplier=1, name="fpn_p3_Depthwise")(P3)
        # P3 = BatchNormalization(name="fpn_p3_Depthwise_BN")(P3)
        P3 = KL.Conv2D(256, (1,1), strides=1, padding='valid', name="fpn_p3_Pointwise")(P3)
        # P3 = BatchNorm(name="fpn_p3_bn")(P3, training=True)
        P3 = BatchNormalization(name="fpn_p3")(P3)
        P4 = KL.DepthwiseConv2D((3,3), strides=1, padding="SAME", depth_multiplier=1, name="fpn_p4_Depthwise")(P4)
        # P4 = BatchNormalization(name="fpn_p4_Depthwise_BN")(P4)
        P4 = KL.Conv2D(256, (1,1), strides=1, padding='valid', name="fpn_p4_Pointwise")(P4)
        # P4 = BatchNorm(name="fpn_p4_bn")(P4, training=True)
        P4 = BatchNormalization(name="fpn_p4")(P4)
        P5 = KL.DepthwiseConv2D((3,3), strides=1, padding="SAME", depth_multiplier=1, name="fpn_p5_Depthwise")(P5)
        # P5 = BatchNormalization(name="fpn_p5_Depthwise_BN")(P5)
        P5 = KL.Conv2D(256, (1,1), strides=1, padding='valid', name="fpn_p5_Pointwise")(P5)
        # P5 = BatchNorm(name="fpn_p5_bn")(P4, training=True)
        P5 = BatchNormalization(name="fpn_p5")(P5)
        P6 = KL.MaxPooling2D(pool_size=(1, 1), strides=2, name="fpn_p6")(P5)
